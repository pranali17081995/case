		...
		op=request.getParameter("op");
		 if(op.equals("adddetails")){
			...
			rd.forward(request, response);
				...
				RequestDispatcher rd = request.getRequestDispatcher("SpocStatusDetails.html");
				rd.forward(request, response);
				
		}
			else if(op.equals("refer")){
				
						RequestDispatcher rd = request.getRequestDispatcher("ReferDetails.html");
						rd.forward(request, response);
			}
		else
		{
